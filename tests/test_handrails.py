...
def test_proof_with_sketch():
    compare_have_want_handrails(
        ...
        <div class="paragraph hr hr-offset hr-hidden" tabindex=0 data-nodeid="3">
...
def test_paragraph_with_mathblock_ending_with_text():
    compare_have_want_handrails(
        ...
        <p>This is a paragraph with math inside of it 
        <div class="mathblock hr hr-hidden" tabindex=0 data-nodeid="3">
